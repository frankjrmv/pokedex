...
{ name: "Vaporeon", height: 1, types: ["water"]},
{ name: "Jolteon", height: 0.8, types: ["electric"]},
{ name: "Flareon", height: 0.9, types: ["fire"]},
{ name: "Espeon", height: 0.9, types: ["psychic"]},
{ name: "Umbreon", height: 1, types: ["dark"]},
{ name: "Leafeon", height: 1, types: ["grass"]},
{ name: "Glaceon", height: 0.8, types: ["ice"]},
{ name: "Sylveon", height: 1, types: ["fairy"]},
